...
class BaselineChallenge(FlowSpec):
    ...
    def baseline(self):
        ...
        from baseline_model import MajorityClassifier
        ...
        baseline_model.fit(self.traindf.label)

        predictions = baseline_model.predict(self.traindf.review)# TODO: predict the majority class
        
        acc = baseline_model.eval_acc(self.traindf.review,self.traindf.label)# TODO: return the accuracy_score of these predictions
        rocauc = baseline_model.eval_auc(self.traindf.review,self.traindf.label) # TODO: return the roc_auc_score of these predictions
    ...
    def model(self):
        ...
        for params in self.hyperparam_set:
            ...
            acc = model.eval_acc(self.df['review'], self.df['label'], .5) # TODO: evaluate your custom model in an equivalent way to accuracy_score.
            rocauc = model.eval_rocauc(self.df['review'], self.df['label']) # TODO: evaluate your custom model in an equivalent way to roc_auc_score.
